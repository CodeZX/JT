...
#import "RotateView.h"
#define KMaxRotation 3.706043
#define KMinRotation 0.660664
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        UIImage *rotateImage = [self reSizeImage:[UIImage imageNamed:@"button.png"] toSize:CGSizeMake(self.frame.size.width, self.frame.size.height)];
...
-(void)loadAllValue{
    ...
    self.ownRotation =  M_PI;//M_PI/9*8;

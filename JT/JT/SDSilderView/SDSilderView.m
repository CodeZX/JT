...
-(instancetype)initWithPosition:(CGPoint)positon viewRadius:(CGFloat)viewRadius{
    ...
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(positon.x, positon.y, viewRadius*2, viewRadius*2);
        [self loadRotateView];
        
        
        UIImage *backgroundImage = [self reSizeImage:[UIImage imageNamed:@"button_bg.png"] toSize:CGSizeMake(viewRadius*2, viewRadius*2)];
